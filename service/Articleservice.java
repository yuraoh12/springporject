...
public class ArticleService {
	...
	public ResultData decreaseGoodReactionPoint(int relId) {
		...
		return ResultData.from("S-1", "좋아요가 감소되었습니다.", "affectedRowsCount", affectedRowsCount);
	}
	...
	public ResultData decreaseBadReactionPoint(int relId) {
		...
		return ResultData.from("S-1", "싫어요가 감소되었습니다.", "affectedRowsCount", affectedRowsCount);
	}
}